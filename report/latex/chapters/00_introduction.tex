...
Sau khi hiểu rõ về cơ sở lý thuyết của phương pháp được chọn, luận văn sẽ tiến hành ứng dụng phương pháp đó cho việc phát hiện trôi dạt trong dữ liệu streaming. Phương pháp này sẽ được thiết kế và cải tiến để đảm bảo khả năng phát hiện nhanh chóng và chính xác đối với nhiều kiểu dữ liệu phức tạp khác nhau.
