...
\begin{quote}
	...
	\end{itemize}
	Do đó, phương pháp SHAPED\_CDT (Chương~\ref{chap:proposed-model}) sử dụng các đặc trưng bổ sung (WR, $n_p$, CV) để phân loại các loại drift này thay vì chỉ dựa vào hình dạng tam giác.
\end{quote}
