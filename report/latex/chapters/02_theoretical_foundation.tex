...
Trong giai đoạn này, ma trận tương đồng (similarity matrix) được xây dựng sử dụng hàm kernel để nắm bắt mối quan hệ giữa các điểm dữ liệu. Gaussian RBF kernel thường được sử dụng:
