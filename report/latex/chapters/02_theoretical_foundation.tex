...
\begin{enumerate}
    \item \textbf{Empirical observation:} Phân tích SNR quan sát trên 8 datasets
    \item \textbf{Neyman-Pearson optimization:} Cân bằng Type I/II errors
    \item \textbf{Strategy balance validation:} Đạt $\sim 50\%$ aggressive / $\sim 50\%$ conservative
\end{enumerate}
