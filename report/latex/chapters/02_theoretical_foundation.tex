...
\textbf{Hạn chế của permutation test:} Số lần resampling $N_{\text{perm}}$ thường lấy ở mức vài nghìn để p-value có độ phân giải tốt; mỗi lần lại phải tính lại kernel matrix, làm cho chi phí của bước kiểm định lớn hơn nhiều lần so với chi phí tính MMD thô. Quan trọng hơn, độ chính xác thống kê của ngưỡng phát hiện chỉ đảm bảo nếu phân phối dưới giả thuyết không trôi dạt được ước lượng phù hợp.
