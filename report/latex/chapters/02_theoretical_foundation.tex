...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|l|}
		...
		$\sigma_k$        & Kernel bandwidth (RBF)       & median heuristic          \\
		$k(x,y)$          & Kernel function              & Gaussian RBF              \\
		\hline
	\end{tabular}
\end{table}

\textit{Lưu ý:} Ký hiệu $\sigma$ được sử dụng với hai nghĩa khác nhau trong tài liệu: (1) drift magnitude signal $\sigma(t)$, và (2) kernel bandwidth $\sigma_k$. Để tránh nhầm lẫn, luận văn sử dụng subscript khi cần phân biệt.
