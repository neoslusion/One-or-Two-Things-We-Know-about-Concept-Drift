...
\textbf{Tích hợp ShapeDD detector:} Triển khai phương pháp ShapeDD với adaptive window sizing (ShapeDD\_Improved) đạt hiệu suất phát hiện drift xuất sắc (F1 = 1.0, delay = 4 samples). Hệ thống sử dụng permutation test với 2500 lần hoán vị đảm bảo độ tin cậy thống kê cao.
...
\textbf{Kết quả nổi bật:} ShapeDD\_Improved đạt được:
\begin{itemize}
    \item F1-score: 1.0 (perfect detection - không false positive, không false negative)
