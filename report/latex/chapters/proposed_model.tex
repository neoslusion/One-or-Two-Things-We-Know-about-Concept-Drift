...
\caption{So sánh hiệu suất trước và sau tối ưu hóa tham số. Ba panel cho thấy sự cải thiện của cấu hình v2 so với v1: (Trái) F1-score tăng từ 0.684 lên 0.697 (+1.9\%), (Giữa) Recall tăng từ 62.5\% lên 66.2\%, (Phải) Balance Score cải thiện từ 14.7 xuống 8.7 (càng gần 0 càng cân bằng). Việc điều chỉnh threshold từ 0.008 lên 0.010 và sensitivity từ high xuống medium đã mang lại cải thiện đáng kể trên tất cả các chỉ số đánh giá.}
...
\caption{Phân tích độ nhạy ngưỡng SNR. (Trái) Cân bằng chiến lược thay đổi theo ngưỡng, cho thấy threshold=0.010 (đường đỏ đứt) đạt 58.7\% gần với mục tiêu 50\% (đường xanh đứt). (Phải) F1-score dự kiến theo ngưỡng, với điểm peak ở vùng 0.008-0.012. Các điểm dữ liệu thực nghiệm (v1 ở 0.008 với F1=0.684, v2 ở 0.010 với F1=0.697) được đánh dấu rõ ràng, xác nhận rằng threshold=0.010 nằm trong vùng tối ưu.}
