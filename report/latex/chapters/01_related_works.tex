...
Trong giai đoạn đầu, CDT-MSW định nghĩa \textbf{tỷ lệ phát hiện} (Detection Flow Ratio) để đo lường sự thay đổi giữa hai cửa sổ dữ liệu $W_A$ và $W_B$:
\begin{equation}
...
Để phân biệt chi tiết giữa các loại trôi dạt tiến triển, CDT-MSW định nghĩa
