...
\textbf{DDM} & Statistical Process Control & Binomial Distribution & Ít tốn bộ nhớ, chạy nhanh [1, 2] & Hiệu suất giảm khi cửa sổ lớn [3] \\ \hline
\textbf{EDDM} & Statistical Process Control & Distance between errors & Nhạy với gradual drift [4, 5] & Dễ báo động giả lúc mới học [6] \\ \hline
\textbf{ADWIN} & Sliding Window & Adaptive Windowing & Có cam kết toán học về tỷ lệ FP [7, 8] & Tốn bộ nhớ hơn DDM/EDDM [6] \\ \hline
\textbf{HDDM} & Sliding Window & Hoeffding's Bound & Phù hợp cho abrupt/gradual drift [9, 10] & Cần dữ liệu nhãn liên tục [11] \\ \hline
\textbf{FHDDM} & Sliding Window & Hoeffding + Sliding Win. & Chỉ duy trì 2 biến số, cực nhẹ [6, 12] & Cần chọn kích thước cửa sổ phù hợp [13] \\ \hline
\textbf{D3} & Virtual Classifier & Unsupervised Separation & Tốc độ nhanh, không cần nhãn [14, 15] & Nhạy cảm với nhiễu tuyến tính [16] \\ \hline
\textbf{ShapeDD} & Meta-Statistic & Shape-based Filtering & Pinpointing điểm drift chính xác [17, 18] & Độ trễ phụ thuộc kích thước cửa sổ [17] \\ \hline
\textbf{DAWIDD} & Block-Based & Independence Test (HSIC) & Phù hợp với gradual/reoccurring drift [19, 20] & Tỷ lệ báo động giả khá cao [21] \\ \hline
\end{tabular}
}
\end{table}

Các phương pháp cũng đã được thực nghiệm trên các tập dữ liệu giả lập và thực tế chuẩn để đánh giá hiệu năng. Bảng \ref{tab:performance_results} tổng hợp kết quả từ các nghiên cứu 

\begin{table}[ht]
\centering
\caption{So sánh Prequential Accuracy (\%) trên các tập dữ liệu Benchmark}
\label{tab:accuracy_results}
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Thuật toán} & \textbf{Electricity (Elec2)} & \textbf{Forest Covtype} & \textbf{Rotating Hyp.} & \textbf{SEA (Sudden)} \\ \hline
\textbf{D3} & 86.69 [22] & 87.17 [22] & 85.29 [22] & 88.08 [23] \\ \hline
\textbf{ADWIN} & 81.33 [22] & 80.48 [22] & 87.28 [22] & 77.59 [23] \\ \hline
\textbf{DDM} & 79.30 [22] & 83.36 [22] & 84.01 [22] & 85.32 [23] \\ \hline
\textbf{EDDM} & 78.25 [22] & 82.76 [22] & 80.27 [22] & 75.73 [23] \\ \hline
\textbf{HDDM-A} & 85.71 [24] & 87.24 [25] & 86.91 [26] & - \\ \hline
\textbf{FHDDM} & 73.62* [27] & 67.76* [28] & 85.08 [25] & - \\ \hline
\textbf{DAWIDD} & 21.00** [29] & 31.82** [29] & 37.18** [30] & 29.93** [30] \\ \hline
\textbf{ShapeDD} & 87.73*** [31] & 96.00*** [31] & 96.00*** [32] & 22.00*** [33] \\ \hline
\end{tabular}
\begin{flushleft}
\small * Tính toán từ tỷ lệ lỗi (Error-rate) của mô hình Hoeffding Tree.\\
** Chỉ số Delay (số mẫu trễ trung bình) - DAWIDD không tập trung vào Accuracy.\\
*** Chỉ số $\beta$-score đánh giá chất lượng bộ dò trên tập dữ liệu tương ứng.
\end{flushleft}
\end{table}
