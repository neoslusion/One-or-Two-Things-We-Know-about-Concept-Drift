...
\begin{enumerate}[label=(\alph*)]
	...
	\item Cập nhật dần (Gradual / Incremental Update) được dùng khi mô hình gặp \emph{gradual} hoặc \emph{incremental drift}. Vì sự thay đổi diễn ra từ từ, mô hình thường cần cập nhật mềm với hệ số học $\eta_t$ nhỏ hơn. Theo Xiang \textit{et al.}~\cite{xiang2023review}, có thể mô hình hoá bằng công thức:
	      \[
