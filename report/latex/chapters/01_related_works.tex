...
\textbf{FHDDM (Fast HDDM)} \todo{Missing reference} được giới thiệu như phiên bản tăng tốc của HDDM, cải thiện cả tốc độ và độ nhạy trong việc phát hiện drift. 
...
\textbf{MDDM (McDiarmid's Drift Detection Method)} \todo{missing reference} là phương pháp áp dụng bất đẳng thức McDiarmid – một bất đẳng thức tập trung (concentration inequality) 
...
\textbf{RDDM (Reactive DDM)} \todo{missing reference} tập trung vào việc tối ưu thời gian phản ứng bằng cách rút ngắn giai đoạn cảnh báo (warning phase) của DDM gốc. 
...
\addlinespace
\textbf{FHDDM} & Sliding Window & Hoeffding + Sliding Win. & Chỉ duy trì 2 biến số, cực nhẹ~\cite{HDDM} & Cần chọn kích thước cửa sổ phù hợp~\cite{hinder2024survey_partA} \\
\addlinespace
