...
\begin{enumerate}[label=\textbf{(\alph*)}]
	...
	\item \textbf{Cập nhật cấu trúc (Structural or Hybrid Adaptation):} Một số nghiên cứu gần đây đề xuất thay đổi cả tham số lẫn \emph{cấu trúc mạng học sâu} khi có drift.
...
\begin{enumerate}
	...
	\item Các phương pháp học sâu hiện nay hướng đến \emph{cập nhật kết hợp} (hybrid adaptation): tinh chỉnh trọng số kết hợp với thay đổi cấu trúc mạng để xử lý trôi dạt dài hạn.
...
\end{enumerate}
Các phương pháp hiện nay kết hợp thông tin thống kê từ bộ phát hiện như CDT-MSW với đặc trưng động của mô hình học sâu để thích ứng theo từng loại trôi dạt, giảm quên kiến thức cũ và cải thiện độ bền vững của hệ thống học trực tuyến.
