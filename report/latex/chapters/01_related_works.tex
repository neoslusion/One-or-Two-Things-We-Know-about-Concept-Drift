...
\textbf{FHDDM} & Sliding Window & Hoeffding + Sliding Win. & Chỉ duy trì 2 biến số, cực nhẹ~\cite{pesaranghader2016fhddm} & Cần chọn kích thước cửa sổ phù hợp~\cite{hinder2024survey_partA} \\ \hline
...
\begin{flushleft}
\small 
\textbf{Ghi chú:} Các chỉ số được tổng hợp từ các nghiên cứu gốc. Giá trị có thể khác nhau tùy theo cấu hình thực nghiệm (classifier, hyperparameters). \\
\textbf{D3}: Kết quả từ~\cite{gozuacik2019d3}. \textbf{DAWIDD}: Kết quả từ~\cite{hinder2020dawidd}. \textbf{ShapeDD}: Kết quả từ~\cite{shapeDD2024}. \\
...
\textit{Mặc dù luận văn tập trung đánh giá \textbf{sudden drift} như đã nêu trong Chương~0, việc hệ thống hóa phương pháp phân loại loại drift là nền tảng quan trọng cho kiến trúc thích ứng thông minh được đề xuất trong Chương~3. Phương pháp CDT\_MSW được tích hợp vào hệ thống ShapeDD-Stream để kích hoạt chiến lược cập nhật mô hình phù hợp với từng loại drift.}
