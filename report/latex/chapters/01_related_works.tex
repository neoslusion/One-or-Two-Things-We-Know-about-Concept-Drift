...
Chương trước đã giới thiệu về hiện tượng trôi dạt khái niệm và tầm quan trọng của việc phát hiện sớm. 
Chương này khảo sát các phương pháp phát hiện drift đã được đề xuất, từ đó làm cơ sở lựa chọn và cải tiến phương pháp cho luận văn.
...
Một phương pháp khác là \textbf{KSWIN} (Kolmogorov–Smirnov WINdowing \cite{wang2020kswin}), kết hợp kiểm định Kolmogorov–Smirnov với cửa 
...
\subsection{So sánh tổng hợp các phương pháp phát hiện drift}

Bảng~\ref{tab:comprehensive-comparison} tổng hợp các phương pháp phát hiện drift theo các tiêu chí quan trọng nhất, giúp lựa chọn phương pháp phù hợp với từng bài toán cụ thể.

\begin{table}[H]
\centering
\caption{So sánh các phương pháp phát hiện drift theo các tiêu chí chính}
\label{tab:comprehensive-comparison}
\begin{tabular}{@{}p{2.5cm}p{2cm}p{2cm}p{2.5cm}p{2.5cm}p{2.5cm}@{}}
\toprule
\textbf{Phương pháp} & \textbf{Cần nhãn?} & \textbf{Loại drift} & \textbf{Độ phức tạp} & \textbf{Độ trễ phát hiện} & \textbf{Phù hợp với} \\
\midrule
DDM & Có & Sudden & $O(1)$ & Trung bình & [TODO] \\
EDDM & Có & Gradual & $O(1)$ & Thấp & [TODO] \\
ADWIN & Không & Cả hai & $O(\log W)$ & Thấp & [TODO] \\
HDDM & Có & Sudden & $O(1)$ & Trung bình & [TODO] \\
KSWIN & Không & Sudden & $O(n \log n)$ & Cao & [TODO] \\
ShapeDD & Không & Sudden & $O(l^2)$ & Thấp & [TODO] \\
ShapeDD SNR-Adaptive & Không & Sudden & $O(l^2)$ & Thấp & [TODO] \\
\bottomrule
\end{tabular}

\vspace{0.5em}
\textit{Ghi chú: [TODO] - Cần bổ sung sau khi hoàn thành phần thực nghiệm. $W$ = kích thước cửa sổ ADWIN, $n$ = số mẫu trong cửa sổ, $l$ = kích thước cửa sổ ShapeDD.}
\end{table}
