...
Luận văn cũng thử nghiệm sử dụng OW-MMD thay cho standard MMD trong SHAPED\_CDT. Tuy nhiên, kết quả cho thấy OW-MMD không phù hợp cho classification do cơ chế variance reduction loại bỏ những thay đổi nhỏ (coi là noise). OW-MMD phù hợp hơn cho drift detection (phát hiện có/không có drift) với F1 = 0.562, nhưng standard MMD tốt hơn cho classification với CAT\_ACC = 80\% so với 20\% của OW-MMD. Chi tiết thử nghiệm được trình bày ở Chương~\ref{chap:experiments}.
