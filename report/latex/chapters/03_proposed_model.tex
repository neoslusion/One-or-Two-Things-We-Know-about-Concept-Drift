...
Trong các hệ thống học máy dòng dữ liệu (data stream), sự trôi dạt khái niệm (concept drift) xảy ra khi các đặc tính thống kê của biến mục tiêu thay đổi đột ngột hoặc từ từ theo thời gian. Các phương pháp MMD truyền thống thường gặp khó khăn về chi phí tính toán khi áp dụng cho dữ liệu lớn.
