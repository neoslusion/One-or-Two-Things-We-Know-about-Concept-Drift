...
\begin{enumerate}
	...
	\item \textbf{Drift Detection Consumer (Bộ phát hiện):} Đọc dữ liệu từ stream, duy trì cửa sổ trượt và thực thi thuật toán ShapeDD-IDW.
	\item \textbf{Drift Classifier (Bộ phân loại):} Được kích hoạt khi có tín hiệu drift, thực thi CDT-MSW để xác định loại drift và gửi sự kiện vào topic \texttt{drift.results}.
