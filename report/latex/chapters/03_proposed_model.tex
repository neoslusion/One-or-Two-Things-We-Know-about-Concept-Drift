...
Với window size $n = 100$, ADW-MMD xử lý khoảng $\approx 50,000$ kernel evaluations mỗi step, so với $\approx 2,500,000$ của ShapeDD gốc. Điều này giải thích tốc độ tăng $\approx 7\times$ trong thực nghiệm.
...
\textbf{Độ phức tạp tính toán của SE-CDT:}
\begin{itemize}
...
\textbf{Giải thích lựa chọn ngưỡng:}
