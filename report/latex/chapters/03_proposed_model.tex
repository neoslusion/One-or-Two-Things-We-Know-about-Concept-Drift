...
\subsubsection{SHAPED\_CDT: Phân loại drift không giám sát}

Phương pháp CDT\_MSW gốc~\cite{guo2022cdtmsw} yêu cầu \textit{labels} để tính toán accuracy ratio, điều này không phù hợp trong môi trường streaming không giám sát. Luận văn đề xuất \textbf{SHAPED\_CDT} (ShapeDD-Enhanced Concept Drift Type --- còn gọi là SE-CDT trong một số tài liệu), một phương pháp thay thế sử dụng trực tiếp tín hiệu drift magnitude $\sigma(t)$ từ ShapeDD để phân loại drift type.
...
\begin{algorithm}[H]
	\caption{SHAPED\_CDT: Phân loại drift không giám sát}
	\label{alg:se-cdt}
	\begin{algorithmic}[1]
...
\textbf{Độ phức tạp tính toán của SHAPED\_CDT:}
\begin{itemize}
