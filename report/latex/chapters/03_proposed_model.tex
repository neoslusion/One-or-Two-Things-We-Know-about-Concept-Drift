...
Kết quả phân loại từ SHAPED\_CDT sẽ được sử dụng để kích hoạt chiến lược thích ứng phù hợp, được trình bày trong phần tiếp theo.

\section{Khung chiến lược thích ứng mô hình}
\label{sec:model-adaptation-framework}

Dựa trên kết quả phân loại drift từ SHAPED\_CDT, hệ thống có thể kích hoạt chiến lược cập nhật mô hình phù hợp. Phần này trình bày khung chiến lược thích ứng (Adaptation Framework).
