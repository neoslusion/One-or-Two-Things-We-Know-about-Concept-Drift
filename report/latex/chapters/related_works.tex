...
Ngoài ra, các nghiên cứu gần đây~\cite{jourdan2023process,xiang2023review,yuan2022advances}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
  ...
  Theo Xiang \textit{et al.}~\cite{xiang2023review}, có thể mô hình hoá bằng công thức:
  \[
  ...
  Deep Ensemble Replay hoặc Continual Learning with Experience Buffer~\cite{yuan2022advances}.

  \item \textbf{Cập nhật cấu trúc (Structural or Hybrid Adaptation):}
  Một số nghiên cứu gần đây~\cite{xiang2023review,yuan2022advances}
...
\begin{enumerate}
  ...
  vừa tinh chỉnh trọng số, vừa thay đổi cấu trúc mạng để xử lý trôi dạt dài hạn~\cite{yuan2022advances}.
