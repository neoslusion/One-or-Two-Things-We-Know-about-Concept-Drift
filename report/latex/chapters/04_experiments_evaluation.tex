...
\begin{figure}[H]
	...
	\caption[Prequential Accuracy trên Sudden Drift]{Prequential Accuracy trên Sudden Drift (Luân phiên). Baseline (đỏ) duy trì accuracy trung bình $\sim$72\% nhờ concept A lặp lại. SE-CDT (xanh) phục hồi nhanh hơn sau mỗi drift event nhưng đạt accuracy tương đương (71.1\%) do kịch bản này quá đơn giản cho adaptation.}
