...
Bảng~\ref{tab:comprehensive_performance} tóm tắt hiệu suất trung bình. Lưu ý rằng các chỉ số F1 được tính dựa trên khả năng phát hiện đúng các điểm drift đã biết (ground truth), kết quả được tổng hợp từ toàn bộ các tập dữ liệu được nhắc đến trước đó.
