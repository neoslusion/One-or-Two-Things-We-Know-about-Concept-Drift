...
\begin{figure}[H]
	...
	\caption[Confusion Matrix - Category Level]{
		\textbf{Confusion Matrix ở mức Category (TCD vs PCD)}: Cho thấy độ chính xác 85.8\%, với hầu hết lỗi nằm trong nội bộ mỗi category (TCD↔PCD errors rất thấp).
	}
...
\textbf{Nhận xét:}
So với paper values của CDT\_MSW, SE-CDT đạt kết quả tương đương về CAT Accuracy (86.5\% vs 87.5\%) nhưng vượt trội về khả năng phát hiện sự kiện (EDR 94.4\% vs 80\%). Đặc biệt, SE-CDT đạt SUB Accuracy cao hơn (48\% vs 42\%), cho thấy khả năng phân loại chi tiết tốt hơn. Điều này có thể được lý giải bởi hai yếu tố kỹ thuật:
\begin{itemize}
