...
Sử dụng chỉ số \textbf{Prequential Accuracy} --- phương pháp đánh giá tuần tự (test-then-train) trong đó mỗi mẫu được sử dụng để kiểm tra hiệu năng mô hình trước khi đưa vào huấn luyện, độ chính xác tích lũy được tính trên toàn bộ quá trình --- trên luồng dữ liệu 5,000 mẫu chứa 5 điểm sudden drift.
