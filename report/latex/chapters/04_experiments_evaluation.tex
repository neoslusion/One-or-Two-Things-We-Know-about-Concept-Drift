...
\begin{figure}[h]
	...
	\caption[Biểu đồ Critical Difference (CD)]{Biểu đồ Critical Difference (CD) với mức ý nghĩa $\alpha = 0.05$. MMD_ADW và ShapeDD_ADW_MMD nằm ở nhóm đầu (rank thấp nhất là tốt nhất).}
...
\begin{figure}[H]
	...
	\caption[Độ chính xác Prequential theo thời gian]{Độ chính xác Prequential theo thời gian. Đường màu xanh (Type-Specific/Simple Retrain) cho thấy độ chính xác phục hồi nhanh chóng sau mỗi điểm drift (ký hiệu tam giác đỏ), trong khi đường màu đỏ (No Adaptation) tiếp tục suy giảm.}
