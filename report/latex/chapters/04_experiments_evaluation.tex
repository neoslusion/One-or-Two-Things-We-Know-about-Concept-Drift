...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{ShapeDD\_SNR\_Adaptive:} Hybrid SNR-aware version
    \begin{itemize}
        \item L1 = 50, L2 = 150, n\_perm = 2500 (fixed, consistent parameters)
        \item Auto-selects aggressive or conservative strategy based on estimated SNR
        \item Uses shape\_adaptive\_v2 for high SNR, original shape for low SNR
    \end{itemize}
\end{itemize}
...
\textbf{ShapeDD\_SNR\_Adaptive} & window & \textbf{Có} & \textbf{4} & \textbf{1} & \textbf{0} & \textbf{1.000} & \textbf{4.0} \\
\midrule
...
\begin{itemize}
    \item \textbf{ShapeDD\_SNR\_Adaptive} đạt hiệu suất tốt nhất:
    \begin{itemize}
...
\textbf{Lý do ShapeDD\_SNR\_Adaptive vượt trội:}
\begin{itemize}
...
\midrule
ShapeDD\_SNR\_Adaptive & 0.996 & 0.550 & 0.446 & 0.919 & 82.8 & 96 \\
...
% =============================================================================
% AUTO-GENERATED TABLE: Runtime Statistics
% Source: experiments/drift_detection_benchmark/publication_figures/table_III_runtime_stats.tex
...
\begin{itemize}
    ...
    \begin{itemize}
        \item ShapeDD\_SNR\_Adaptive: 1.615 ms/sample
...
\textbf{1. Hiệu quả của ShapeDD\_SNR\_Adaptive:}
\begin{itemize}
...
\textbf{ShapeDD\_SNR\_Adaptive vs. Streaming detectors:}
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Cần accuracy cao:} Chọn ShapeDD\_SNR\_Adaptive
...
\begin{itemize}
    ...
    \item KS significantly better than D3, MMD\_OW (p < 0.05)
    \item Không có significant difference giữa top-4 methods (KS, MMD, DAWIDD, ShapeDD)
\end{itemize}
