...
\begin{table}[H]
	\centering
	\caption{F1-Score của các phương pháp theo từng loại dataset}
...
Hình~\ref{fig:runtime-comparison} và Hình~\ref{fig:throughput-comparison} minh họa sự cải thiện về hiệu suất tính toán.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{../../results/plots/runtime_comparison.png}
	\caption[Runtime Comparison]{
		\textbf{So sánh Runtime trên benchmark datasets}: SE\_CDT (7.6ms/window) nhanh hơn ShapeDD (158.4ms) gấp 20.5 lần, cho phép xử lý real-time streams.
	}
...
\textbf{Nhận xét:}
So với paper values của CDT\_MSW, SE-CDT đạt kết quả tương đương về CAT Accuracy (81.2\% vs 87.5\%) nhưng vượt trội về khả năng phát hiện sự kiện (EDR 94.4\% vs 80\%). Đặc biệt, SE-CDT đạt SUB Accuracy cao hơn (50\% vs 42\%), cho thấy khả năng phân loại chi tiết tốt hơn. Điều này có thể được lý giải bởi hai yếu tố kỹ thuật:
\begin{itemize}
...
Hình~\ref{fig:signal_shapes_comparison} minh họa sự khác biệt trong hình dạng tín hiệu MMD cho các loại drift, giải thích tại sao Sudden detection tốt hơn Gradual.
...
\end{figure}\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{../../results/plots/vis_repeated_gradual_SE.png}
	\caption[Signal Shape - Gradual Drift]{Tín hiệu SE-CDT cho Gradual drift: Plateau kéo dài, không có peak rõ ràng, cần temporal features để phát hiện.}
	\label{fig:signal_gradual}
\end{figure}
