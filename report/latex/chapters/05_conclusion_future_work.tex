...
\subsection{Đóng góp về phân loại drift không giám sát (SE-CDT)}

Luận văn đề xuất phương pháp \textbf{SE-CDT (ShapeDD-Enhanced CDT)} — một phương pháp phân loại drift không giám sát dựa trên tín hiệu MMD $\sigma(t)$ (xem Chi tiết tại Chương~\ref{chap:proposed-model} và kết quả thực nghiệm tại Chương~\ref{chap:experiments}).

\textbf{Kết quả chính:}
\begin{itemize}
    \item Phân loại cấp Category (TCD vs PCD): Đạt \textbf{88\%} accuracy
