...
\begin{enumerate}
	...
	\item \textbf{Phân loại không giám sát:} SE-CDT đạt \textbf{CAT = 85.8\%} mà không cần labels, cao hơn so với CDT\_MSW supervised (38.7\%) trong điều kiện thử nghiệm cụ thể (window\_size = 50).
\end{enumerate}
