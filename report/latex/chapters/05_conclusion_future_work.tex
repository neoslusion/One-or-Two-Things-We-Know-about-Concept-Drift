...
\begin{itemize}
    ...
    \item \textbf{ShapeDD\_OW\_MMD xếp hạng 2 (F1 = 0.562):} Kết hợp OW-MMD với đặc trưng hình dạng, throughput $\approx 47,000$ samples/giây
    \item \textbf{Friedman test p = 0.8161:} Không có sự khác biệt thống kê đáng kể giữa các phương pháp
    \item Key finding: OW-MMD variance reduction cho phép giảm bootstrap từ 2500 xuống 10 mà không mất accuracy
    \item Practical contribution: Cải thiện throughput $\approx 7\times$ so với ShapeDD gốc
\end{itemize}
