...
\textbf{So sánh detector toàn diện:} Đánh giá 8 drift detectors trên 11 datasets, tập trung vào các bộ dữ liệu tổng hợp (synthetic) được thiết kế để mô phỏng đa dạng các kịch bản thực tế, với 10 drift points mỗi dataset. Kết quả cho thấy các phương pháp có trade-offs khác nhau phù hợp với các use cases khác nhau.

\textbf{Kết quả comprehensive benchmark (8 methods × 11 datasets):}
\begin{itemize}
