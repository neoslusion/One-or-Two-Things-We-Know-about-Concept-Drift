...
SE-CDT (Std) đạt EDR = 94.4\% nhưng có số lượng False Positives cao (FP = 1394). SE-CDT (IDW) giảm FP xuống 171 nhưng EDR giảm còn 50.6\%. Trong môi trường production cần cân nhắc trade-off này:
\begin{itemize}
