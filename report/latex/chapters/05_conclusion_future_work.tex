...
\subsection{Thiếu Baseline Cập Nhật Định Kỳ (Periodic Retraining)}
Trong chương \ref{chap:experiments}, đánh giá chiến lược thích ứng (adaptation) hiện tại đang tập trung đối chiếu với baseline không cập nhật (No Adaptation). Thiết kế này tuy chứng minh được hệ thống có phản ứng linh hoạt khi drift xảy ra, nhưng để chứng minh đầy đủ tỷ lệ đánh đổi (trade-off) về tài nguyên tính toán đối với bài toán trên production, cần thêm phân tích toàn diện với các baseline cập nhật mù định kỳ (Periodic Retraining). Dù baseline này đã được tích hợp bổ sung vào hệ thống thực nghiệm, luận văn vẫn xem việc mở rộng đánh giá chuyên sâu cho nó là một hướng cải thiện quan trọng để khẳng định tính ưu việt của phương pháp cập nhật theo văn cảnh (context-aware adaptation).
...
\begin{itemize}
	\item \textbf{Gradual Drift:} Nghiên cứu đặc trưng lý thuyết của tín hiệu MMD đối với drift dần dần (không có dạng tam giác nhọn). Một hướng tiềm năng là \textit{multi-scale MMD analysis}: tính MMD đồng thời ở nhiều kích thước cửa sổ (ví dụ: 50, 150, 300 mẫu) để khôi phục thông tin về tốc độ thay đổi phân phối, thay thế Growth process yêu cầu labels của CDT-MSW gốc.
