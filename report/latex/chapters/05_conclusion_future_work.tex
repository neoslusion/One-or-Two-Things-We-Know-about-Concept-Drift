...
\begin{itemize}
	...
	\item \textbf{Phân tích độ trễ và chi phí:} Chứng minh hiệu quả của việc loại bỏ permutation test và thay bằng asymptotic p-value nhờ IDW-MMD, giúp giảm độ trễ phát hiện trung bình xuống còn 18 mẫu.
\end{itemize}
...
\begin{enumerate}
	...
	\item \textbf{Trade-off giữa Tốc độ và Độ chính xác:} Các phương pháp cửa sổ trượt truyền thống chính xác nhưng chậm. Việc tích hợp IDW-MMD với asymptotic p-value đã giải quyết nút thắt này, đưa tốc độ xử lý của phương pháp dựa trên kernel tiệm cận với các thuật toán thống kê nhẹ (như ADWIN) mà không hy sinh độ chính xác.
...
Hành trình giải quyết bài toán concept drift là một quá trình liên tục. Luận văn này đã đóng góp một bước tiến cụ thể thông qua việc (1) tích hợp trọng số nghịch mật độ (inverse density weighting) và asymptotic p-value để giải quyết bài toán hiệu năng, và (2) đề xuất hướng tiếp cận phân loại drift không giám sát (SE-CDT) để định hướng thích ứng.
