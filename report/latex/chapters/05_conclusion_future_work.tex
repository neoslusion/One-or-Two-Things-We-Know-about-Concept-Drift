...
\begin{enumerate}
	...
	\item \textbf{Thích ứng hiệu quả:} Type-Specific Adaptation đạt \textbf{+22.14\%} so với No Adaptation và \textbf{+13.4\%} so với Simple Retrain trên kịch bản \textbf{Stepping Drift} ($N=5$ lần chạy; xem Chương~\ref{chap:experiments}), khẳng định giá trị của chiến lược thích ứng theo loại drift.
\end{enumerate}
