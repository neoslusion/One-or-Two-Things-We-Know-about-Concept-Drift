...
\section{Khung chiến lược thích ứng}
...
\textbf{Bộ dữ liệu Abrupt Drift:} Chúng tôi tạo ra các bộ dữ liệu với thay đổi đột ngột, tức thời trong phân phối dữ liệu. Bộ dữ liệu bao gồm 10,000 điểm dữ liệu với sampling đồng nhất trong không gian đơn vị. Drift được giới thiệu bằng cách dịch chuyển các tham số phân phối tại các điểm thời gian được chọn ngẫu nhiên:
