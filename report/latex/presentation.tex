...
\begin{frame}{ShapeDD - Ưu và nhược điểm}
	...
	\begin{block}{Động lực cải tiến}
		Các hạn chế này dẫn đến các cải tiến: MMDAgg (multi-kernel), ADW-MMD (adaptive density weighting)
	\end{block}
\end{frame}
...
\begin{frame}{Cải tiến 1: Adaptive Density-Weighted MMD (ADW-MMD)}
	\textbf{Vấn đề:}
	\begin{itemize}
...
\begin{frame}{Kết quả Benchmark Tổng hợp (30 Runs)}
	...
	\textbf{Nhận xét:}
	\begin{itemize}
		\item \textbf{ADW-MMD:} Vô địch về F1 và Tốc độ (nhanh nhất, chính xác nhất).
...
\begin{frame}{SOTA Methods (2024-2025)}
	\begin{table}
		...
		\begin{tabular}{llccc}
			...
			\rowcolor{green!10}
			\textbf{Our Method (ADW-MMD)} & Unsupervised    & 0.576         & 0\%             & 2025          \\
