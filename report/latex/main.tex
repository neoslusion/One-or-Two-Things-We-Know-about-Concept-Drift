...
\usepackage{xcolor}   % must be loaded before any \colorlet / \definecolor / \textcolor in the preamble
\usepackage{listings}
\usepackage{ragged2e}
...
\usepackage{algpseudocode} % IEEE-standard algorithmic layout (algorithmicx)
\usepackage{url}
...
\usepackage{tikz} % For flowcharts and diagrams
...
\cleardoublepage
% \enablefancyplain  % Disabled: command definition was removed during template simplification
\pagestyle{fancy}
