...
% Chapter title formatting - Vietnamese style (14pt, bold, uppercase, centered)
\titleformat{\chapter}[display]
{\centering\bfseries\fontsize{14}{16.8}\selectfont}
{CHƯƠNG \thechapter}
{0.5em}
{\MakeUppercase}
\titlespacing*{\chapter}{0pt}{0pt}{30pt}

% Special formatting for unnumbered chapters (14pt, bold, uppercase, centered)
...
% Section formatting (13pt, bold)
\titleformat{\section}[block]
{\bfseries\fontsize{13}{15.6}\selectfont}
{\thesection.}
{0.5em}
{}
\titlespacing*{\section}{0pt}{18pt}{12pt}

% Subsection formatting (12pt, bold)
...
% Subsubsection formatting (12pt, bold)
...
% TOC formatting (14pt, bold, uppercase, centered)
\renewcommand{\cfttoctitlefont}{\centering\bfseries\fontsize{14}{16.8}\selectfont\MakeUppercase}
\renewcommand{\cftloftitlefont}{\centering\bfseries\fontsize{14}{16.8}\selectfont\MakeUppercase}
\renewcommand{\cftlottitlefont}{\centering\bfseries\fontsize{14}{16.8}\selectfont\MakeUppercase}
