...
Phần này chứa các bảng số liệu thống kê chi tiết từ các thí nghiệm phát hiện và thích ứng với sudden drift được thực hiện trong nghiên cứu.

\subsection*{A.1 Kết quả phát hiện sudden drift trên 7 datasets}

\begin{table}[h]
\centering
\caption{Kết quả chi tiết của ShapeDD trên từng dataset (Sudden Drift)}
\label{tab:detailed_detection_results}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
\textbf{Dataset} & \textbf{Precision} & \textbf{Recall} & \textbf{F1-Score} & \textbf{Detection Delay} & \textbf{False Alarms} \\
\hline
SEA Abrupt 1 & 1.00 & 1.00 & 1.00 & 4 samples & 0 \\
SEA Abrupt 2 & 1.00 & 1.00 & 1.00 & 4 samples & 0 \\
STAGGER Abrupt 1 & 1.00 & 1.00 & 1.00 & 3 samples & 0 \\
STAGGER Abrupt 2 & 1.00 & 1.00 & 1.00 & 5 samples & 0 \\
Hyperplane Sudden 1 & 1.00 & 1.00 & 1.00 & 4 samples & 0 \\
Hyperplane Sudden 2 & 1.00 & 1.00 & 1.00 & 4 samples & 0 \\
Hyperplane Sudden 3 & 1.00 & 1.00 & 1.00 & 3 samples & 0 \\
\hline
\textbf{Trung bình} & \textbf{1.00} & \textbf{1.00} & \textbf{1.00} & \textbf{3.9 samples} & \textbf{0} \\
\hline
\end{tabular}
\end{table}

\subsection*{A.2 Kết quả phân loại loại drift với CDT\_MSW}

\begin{table}[h]
\centering
\caption{Độ chính xác phân loại drift type của CDT\_MSW}
\label{tab:drift_classification}
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Dataset} & \textbf{True Drift Type} & \textbf{Predicted Type} & \textbf{Classification Accuracy} \\
\hline
SEA Abrupt 1 & Sudden & Sudden & 100\% \\
SEA Abrupt 2 & Sudden & Sudden & 100\% \\
STAGGER Abrupt 1 & Sudden & Sudden & 100\% \\
STAGGER Abrupt 2 & Sudden & Sudden & 100\% \\
Hyperplane Sudden 1 & Sudden & Sudden & 100\% \\
Hyperplane Sudden 2 & Sudden & Sudden & 100\% \\
Hyperplane Sudden 3 & Sudden & Sudden & 100\% \\
\hline
\textbf{Tổng thể} & \multicolumn{3}{c|}{\textbf{7/7 datasets phân loại chính xác (100\%)}} \\
\hline
\end{tabular}
\end{table}

\subsection*{A.3 Hiệu suất adaptation strategy}

\begin{table}[h]
\centering
\caption{Tỷ lệ phục hồi hiệu suất sau khi thích ứng (Full Model Reset)}
\label{tab:adaptation_performance}
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Dataset} & \textbf{Pre-Drift Acc} & \textbf{Post-Drift Acc} & \textbf{After Adaptation} & \textbf{Recovery Rate} \\
\hline
SEA Abrupt 1 & 0.92 & 0.54 & 0.89 & 86.0\% \\
SEA Abrupt 2 & 0.91 & 0.51 & 0.87 & 84.3\% \\
STAGGER Abrupt 1 & 0.95 & 0.48 & 0.91 & 87.8\% \\
STAGGER Abrupt 2 & 0.94 & 0.52 & 0.90 & 86.4\% \\
Hyperplane Sudden 1 & 0.88 & 0.49 & 0.82 & 79.5\% \\
Hyperplane Sudden 2 & 0.89 & 0.50 & 0.84 & 81.0\% \\
Hyperplane Sudden 3 & 0.90 & 0.47 & 0.86 & 83.2\% \\
\hline
\textbf{Trung bình} & \textbf{0.913} & \textbf{0.501} & \textbf{0.870} & \textbf{82.8\%} \\
\hline
\end{tabular}
\end{table}

\textit{Chú thích: Recovery Rate = (After Adaptation - Post-Drift) / (Pre-Drift - Post-Drift) × 100\%}

\subsection*{A.4 Tham số tối ưu cho ShapeDD trên sudden drift}

\begin{table}[h]
\centering
\caption{Cấu hình tham số tối ưu}
\label{tab:optimal_parameters}
\begin{tabular}{|l|c|l|}
\hline
\textbf{Tham số} & \textbf{Giá trị} & \textbf{Mô tả} \\
\hline
Window size ($L_1$) & 0.05 × stream length & Kích thước cửa sổ trượt \\
Kernel bandwidth ($\sigma$) & Median heuristic & Tự động từ dữ liệu \\
Significance level ($\alpha$) & 0.05 & Ngưỡng p-value \\
Permutation count & 1000 & Số lần hoán vị cho test \\
Weight function & Triangular & Hàm trọng số tạo hình dạng \\
\hline
\end{tabular}
\end{table}
