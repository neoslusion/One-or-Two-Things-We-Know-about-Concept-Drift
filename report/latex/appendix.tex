...
\begin{table}[H]
	...
	\begin{tabular}{|l|c|p{7cm}|}
		...
		Weight method & inverse\_density & Phương pháp tính trọng số IDW-MMD (alias \texttt{variance\_reduction} trong mã nguồn) \\
...
\begin{table}[H]
	...
	\begin{tabular}{|l|c|p{7cm}|}
		...
		\hline
		\multicolumn{3}{|c|}{\textit{BlipProfile --- biến thể noisy (kết hợp với compact\_pair)}} \\
		\hline
		...
		drift\_length & $> 1$ & FWHM vượt ngưỡng TCD/PCD do nhiễu \\
		\hline
