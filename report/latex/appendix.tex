...
# Create drift-stream topic
bin/kafka-topics.sh --create --topic drift-stream --bootstrap-server localhost:9092 --partitions 3 --replication-factor 1
\end{lstlisting}
...
git clone https://github.com/lephuc/concept-drift-thesis  % URL repository kèm bản nộp
