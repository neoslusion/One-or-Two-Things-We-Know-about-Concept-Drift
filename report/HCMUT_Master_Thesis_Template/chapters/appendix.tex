\chapter*{PHỤ LỤC}
\addcontentsline{toc}{chapter}{PHỤ LỤC A. BẢNG CẤU HÌNH THAM SỐ THỰC NGHIỆM}

\begin{center}
{\Huge\bfseries BẢNG CẤU HÌNH THAM SỐ THỰC NGHIỆM}
\end{center}
...
\begin{table}[H]
	\centering
	\caption*{Bảng PL.1: Cấu hình tham số Detection Module (ShapeDD-IDW)}
...
\begin{table}[H]
	\centering
	\caption*{Bảng PL.2: Cấu hình tham số Classification Module (SE-CDT)}
	\begin{tabular}{|l|c|p{7cm}|}
		\hline
		\textbf{Tham số} & \textbf{Giá trị} & \textbf{Mô tả} \\
		\hline
...
\begin{table}[H]
	\centering
	\caption*{Bảng PL.3: Cấu hình Benchmark đánh giá}
	\begin{tabular}{|l|c|p{7cm}|}
		\hline
		\textbf{Tham số} & \textbf{Giá trị} & \textbf{Mô tả} \\
		\hline
...
\begin{table}[H]
	\centering
	\caption*{Bảng PL.4: Cấu hình nguyên mẫu Kafka}
	\begin{tabular}{|l|c|p{7cm}|}
		\hline
		\textbf{Tham số} & \textbf{Giá trị} & \textbf{Mô tả} \\
		\hline
