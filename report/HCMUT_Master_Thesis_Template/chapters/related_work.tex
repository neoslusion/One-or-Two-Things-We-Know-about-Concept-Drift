...
Tuy nhiên, việc dùng độ chính xác mô hình làm tín hiệu khiến CDT-MSW phụ thuộc vào nhãn $y$, không khả dụng cho môi trường không giám sát của luận văn. SE-CDT thay tín hiệu tỉ lệ độ chính xác (accuracy ratio) bằng tín hiệu MMD đo trên cửa sổ trượt nhưng giữ lại cách phân nhóm CAT/SUB ở trên (Chương~\ref{chap:proposed-model}).
