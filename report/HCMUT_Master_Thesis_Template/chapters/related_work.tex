...
\begin{table}[H]
	...
	\begin{tabular}{@{}lp{2.8cm}p{2.5cm}p{3cm}p{3cm}@{}}
		...
		\addlinespace
		\textbf{DAWIDD}     & Block-Based                 & Independence Test (HSIC --- Hilbert-Schmidt Independence Criterion) & Phù hợp với gradual/reoccurring drift~\cite{hinder2020dawidd} & Tỷ lệ báo động giả khá cao~\cite{hinder2024survey_partA}                 \\
		\bottomrule
	\end{tabular}
\end{table}
