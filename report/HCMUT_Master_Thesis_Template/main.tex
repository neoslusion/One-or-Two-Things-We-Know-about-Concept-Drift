...
\newcommand{\defensedate}{ngày \dotfill\ tháng \dotfill\ năm 20\dotfill}
...
\input{ext_pages/task_sheet_VN}  % BIEU MAU 5, the compliant task sheet
\input{ext_pages/task_sheet}     % English courtesy copy, kept after the official one
